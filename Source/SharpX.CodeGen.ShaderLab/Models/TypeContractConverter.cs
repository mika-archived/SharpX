...
namespace SharpX.CodeGen.ShaderLab.Models
{
    ...
    {
        private const string PrimitiveNamespace = "SharpX.Library.ShaderLab.Primitives";
        private const string AbstractionsNamespace = "SharpX.Library.ShaderLab.Primitives.Abstractions";
